    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl border border-gray-100 w-full max-w-sm animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="flex gap-2 px-6 pb-6">
          ...
          <button
            onClick={onConfirm}
            className="flex-1 py-2.5 rounded-xl bg-red-500 text-white text-sm font-semibold hover:bg-red-600 active:bg-red-700 transition-all shadow-sm shadow-red-200"
          >
            {confirmLabel}
          </button>
        </div>
...
export function JobCopilot({ job, onJobUpdate }: JobCopilotProps) {
  ...
  // Abre o modal e aguarda resposta do usuário via Promise
  ...
  return (
    <>
      ...
      <ConfirmModal
        ...
        description='Essa ação vai apagar o status "Aplicado" desta vaga. Tem certeza que deseja continuar?'
